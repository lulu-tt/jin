    ...
    <div className="flex flex-col h-full bg-slate-50 overflow-hidden">
      ...
      <header className="bg-white border-b px-8 py-4 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center overflow-hidden border-2 border-blue-100 shadow-sm">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="relative p-6 bg-blue-50/50 rounded-2xl border border-blue-100/50 flex items-center gap-6 overflow-hidden">
                  <div className="flex-1">
                    <h4 className="font-bold text-blue-900 mb-1">우리 디플리가 더 똑똑해졌어요! 🚀</h4>
                    <p className="text-xs text-blue-700/70 leading-relaxed">디플리의 답변 톤앤매너와 시스템 가이드를 설정하여 사용자에게 더 따뜻한 경험을 선물해 주세요.</p>
                  </div>
                  <img src={characterEdu} alt="Mascot Edu" className="w-20 h-20 object-contain drop-shadow-md" />
                </div>
                <div className="space-y-2">
